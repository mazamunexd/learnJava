public class Newsfeed2 {
    ...
    public Newsfeed2(String[] initialArticles, int[] initialViews, double[] initialRatings){
  ...
  public static void main(String[] args){
    ...
    Newsfeed2 robotTimes = new Newsfeed2(robotArticles, robotViewers, robotRatings);
