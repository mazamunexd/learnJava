public class Newsfeed1 {
    ...
    public Newsfeed1(String[] initialArticles, int[] initialViews, double[] initialRatings){
  ...
  public static void main(String[] args){
    ...
    Newsfeed1 robotTimes = new Newsfeed1(robotArticles, robotViewers, robotRatings);
